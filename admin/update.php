<?php
    ...
    if(!empty($_POST))
    {
        ...
        else if($isUploadSuccess && !$isUploadSuccess)
        {
            $db = Database::connect();
    ...
    else
    {
        ...
        $statement->execute(array($id));
        $item = $statement->fetch();
        $name = checkInput($item['name']);
        $description = checkInput($item['description']);
        $price = checkInput($item['price']);
        ...
        <div class="container admin">
            <div class="row">
                ...
                <div class="col-sm-6 site">
                    <div class="thumbnail">
                        <img src="<?php echo '../images/' . $image; ?>" alt="menu classic">
